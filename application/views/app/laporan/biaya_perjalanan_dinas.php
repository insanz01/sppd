                    ...
                    <tbody>
                      ...
                      <?php foreach ($reports as $laporan) : ?>
                        <tr>
                          ...
                          <td>
                            <a href="<?= base_url('pengajuan/bpd/') . $laporan['hash_id'] ?>" class="badge badge-sm badge-success badge-pill">Terima</a>
                            <a href="<?= base_url('pengajuan/bpd/') . $laporan['hash_id'] ?>" class="badge badge-sm badge-danger badge-pill">Tolak</a>
                          </td>
                        </tr>
                      <?php endforeach; ?>
                    </tbody>
