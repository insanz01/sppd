...
<html lang="en">
  <head>
    ...
    <title>Data Pengganti Surat Perintah Perjalanan Dinas</title>
  </head>
  <body class="container-fluid">
    ...
    <h3 class="text-center mb-2">Data Pengganti Surat Perintah Perjalanan Dinas</h3>
      ...
      <tbody>
        ...
        <?php foreach($all_surat as $surat): ?>
          <tr>
            ...
            <td><?= $surat['nip_karyawan_pengganti'] ?></td>
            <td><?= $surat['nama_karyawan_pengganti'] ?></td>
          </tr>
        <?php endforeach; ?>
      </tbody>
    </table>
