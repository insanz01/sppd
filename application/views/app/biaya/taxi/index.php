<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Biaya Perjalanan Taxi</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
          <div class="row">
            <div class="col-12">
              <a href="<?= base_url('biaya/taxi/add') ?>" class="btn btn-primary float-right mb-2">TAMBAH DATA PERJALANAN</a>
              <a href="<?= base_url("print/biaya/taxi") ?>" target="_blank" class="btn btn-info float-right mx-1 mb-2">
...
<div class="modal fade" id="hapusModal" tabindex="-1" aria-labelledby="hapusModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?= base_url("biaya/taxi/delete") ?>" method="post">
