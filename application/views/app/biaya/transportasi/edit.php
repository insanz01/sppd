<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Ubah Biaya Transportasi</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              <form action="<?= base_url('biaya/transportasi/do_edit/') . $id ?>" method="post">
                ...
                <div class="form-group">
                  ...
                  <a href="<?= base_url("biaya/transportasi") ?>" role="button" class="btn btn-warning btn-block btn-lg">BATAL SIMPAN</a>
                </div>
              </form>
            </div>
          </div>
