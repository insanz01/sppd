...
<html lang="en">
  <head>
    ...
    <title>Surat Pengganti Perjalanan Dinas</title>
  </head>
  <body class="container-fluid">
    ...
    <h1 class="text-center">SURAT PERNYATAAN PENGGANTI TUGAS PERJALANAN DINAS</h1>
    <h4 class="text-center">NOMOR : <?= $surat['nomor_SPPD']; ?></h4>
    ...
    <div class="row">
      <div class="col-9 mx-auto">
        <table class="table custom-table" style="width: 100%">
          <tr>
            <td width="30%">Nama</td>
            <td width="70%"><?= $surat['nama_karyawan']; ?></td>
          </tr>
          <tr>
            <td width="30%">NIP</td>
            <td width="70%"><?= $surat['nip_karyawan']; ?></td>
          </tr>
        </table>
      </div>

      <div class="col-9 mx-auto">
        <p>menyatakan dengan sesungguhnya, bahwa tugas Perjalanan Dinas Jabatan diganti atas nama :</p>
        <table class="table custom-table" style="width: 100%">
          <tr>
            <td width="30%">Nama</td>
            <td width="70%"><?= $surat['nama_karyawan_pengganti']; ?></td>
          </tr>
          <tr>
            <td width="30%">NIP</td>
            <td width="70%"><?= $surat['nip_karyawan_pengganti']; ?></td>
          </tr>
        </table>
      </div>
